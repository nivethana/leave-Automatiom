package com.sgic.automation.leave.utils;
...
public class PageBase {
    public static WebDriver driver;
        ...
        private static String uploadFilepath=System.getProperty("user.dir")+File.separator+"src"+File.separator+"test"+File.separator+"resources"+File.separator+"fileUpload";
